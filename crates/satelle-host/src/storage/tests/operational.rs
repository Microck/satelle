...
fn operational_evidence_schema_is_migrated_atomically_to_version_sixteen() {
    ...
    assert_eq!(19_i64, pragma_integer(connection, "user_version"));
    ...
    assert_eq!(
        vec![
            ...
            13_i64, 14_i64, 15_i64, 16_i64, 17_i64, 18_i64, 19_i64,
        ],
        versions
    );
...
fn version_fifteen_logs_upgrade_preserves_rows_and_normalizes_lifecycle_sources() {
    ...
    connection
        ...
        .expect("remove the version eighteen audit table from the version fifteen fixture");
    connection
