...
fn validate_host_release_compatibility(
    compatibility: &satelle::core::host_update::HostReleaseCompatibility,
    version: &str,
    cli_version: &str,
) -> Result<(), SatelleError> {
    use satelle::core::host_update::{HOST_PROTOCOL_VERSION, HOST_STORAGE_SCHEMA_VERSION};
...
impl GithubReleaseSource {
    ...
    fn fetch_host_compatibility(
        &self,
        version: &str,
    ) -> Result<satelle::core::host_update::HostReleaseCompatibility, SelfUpdateError> {
...
mod tests {
    ...
    fn remote_update_json_has_the_closed_batch_summary_shape() {
        ...
        let remote_update = crate::host_update_batch::RemoteHostUpdateBatchReport::new(vec![
            crate::host_update_batch::RemoteHostUpdateOutcome::completed(
                satelle::core::host_update::HostUpdateReport::new("office", Vec::new(), Vec::new()),
                None,
                &[],
            ),
        ]);
    ...
    fn self_update_artifacts_match_the_authoritative_controller_matrix() {
        let platforms: Value = serde_json::from_str(include_str!("../assets/platforms.json"))
