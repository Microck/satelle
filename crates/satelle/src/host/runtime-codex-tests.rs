...
use crate::core::{ControlPlaneCapability, ControlPlaneOperation, ErrorCode, SatelleError};
use crate::host::runtime::{ReadinessCacheKey, ReadinessObservationState};
use serde_json::json;
...
fn fixture_command(test_name: &str) -> Command {
    ...
    command.args([
        "--exact",
        &format!("host::codex_capabilities::control_plane_tests::{test_name}"),
        "--ignored",
        "--nocapture",
        "--quiet",
    ]);
