...
use crate::core::sensitive_diagnostics::{DesktopSnapshotExportOutcome, DesktopSnapshotManifest};
        ...
        transaction
            .execute(
                ...
                params![
                    ...
                    desktop_binding.as_str(),
                    desktop_session_ref,
                    crate::core::sensitive_diagnostics::DESKTOP_SNAPSHOT_REDACTION_POLICY_VERSION,
