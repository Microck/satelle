use super::codec::{format_time, unix_timestamp_nanos};
...
use crate::core::session::HostIdentityRef;
use crate::host::api_auth::{
...
use crate::host::provider_auth::ProviderSmokeHmacKey;
...
impl ApiTokenRegistration {
    pub(crate) fn new(
        ...
        if desktop_bindings
            .iter()
            .any(|binding| crate::core::session::DesktopBindingRef::new(binding).is_err())
        {
            return Err(StorageError::new(StorageErrorKind::InvalidInput));
        }
        Ok(Self {
