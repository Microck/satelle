...
use crate::host::storage::{PlatformLogSink, PlatformLogSinkHealth};
use crate::host::{DaemonLogEntry, LogSeverity, LogSubject};
...
impl OperatorLogPolicy {
    pub(crate) fn new(root: PathBuf) -> Self {
        Self {
            ...
            retained_files: crate::core::DEFAULT_OPERATOR_LOG_RETAINED_FILES,
        }
    }
...
impl OperatorLogSink {
    ...
    fn ensure_directory(&mut self) -> Result<(), OperatorLogFailureKind> {
        if self.directory.is_none() {
            ...
            for generation in
                self.policy.retained_files..=crate::core::MAX_OPERATOR_LOG_RETAINED_FILES
            {
