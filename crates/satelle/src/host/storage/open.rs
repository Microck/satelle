...
const MIGRATIONS: [Migration; 24] = [
    ...
    Migration {
        version: 12,
        sql: include_str!("0012_provider_descriptor_validation_replay.sql"),
        seeds_sensitive_state: false,
        irreversible: false,
    },
    Migration {
    ...
    Migration {
        version: 15,
        sql: include_str!("0015_turn_admission_readiness.sql"),
        seeds_sensitive_state: false,
        irreversible: false,
    },
    Migration {
    ...
    Migration {
        version: 21,
        sql: include_str!("0021-desktop-snapshot-audit.sql"),
        seeds_sensitive_state: false,
        irreversible: true,
    },
    Migration {
        version: 22,
        sql: include_str!("0022-recording-audit.sql"),
        seeds_sensitive_state: false,
        irreversible: false,
    },
    Migration {
...
const _: () = assert!(
    MIGRATIONS[MIGRATIONS.len() - 1].version
        == crate::core::host_update::HOST_STORAGE_SCHEMA_VERSION
);
