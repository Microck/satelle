...
use crate::core::session::DesktopBindingRef;
use crate::host::runtime::VerifiedSetupPostconditions;
...
impl SetupActionPlan {
    pub fn new(
        ...
        retry_safe: bool,
    ) -> Result<Self, crate::core::SatelleError> {
        Self::try_new(action_id, label, retry_safe).map_err(crate::host::runtime::storage_error)
    }
