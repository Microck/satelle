...
use crate::core::daemon_service::DaemonResolvedPathSet;
...
use crate::core::session::{PublicSession, TurnAdmissionFailure};
use crate::core::{
...
pub struct ProviderDescriptorValidationOptions {
    mode: crate::core::ProviderAuthValidationMode,
...
impl ProviderDescriptorValidationOptions {
    ...
    pub const fn mode(self) -> crate::core::ProviderAuthValidationMode {
        self.mode
    }
...
pub mod test_support {
    pub use crate::host::storage::TestStateDir;
    pub use crate::host::test_runtime::DETACHED_EXECUTION_TRACE_MARKER;
}
...
mod bootstrap_maintenance_tests {
    ...
    fn host_update_plan_has_one_ordered_host_update_ledger() {
        ...
        let recovery_identity = crate::core::host_update::HostUpdateRecoveryIdentity::new(
    ...
    fn bootstrap_heartbeat_recovery_transition_failure_is_nonterminal_and_recoverable() {
        ...
        let operation_id = "bootstrap-operation-heartbeat-retain-failure";
        {
            ...
            assert_eq!(crate::core::ErrorCode::StorageIntegrityFailed, error.code);
            assert_ne!(crate::core::ErrorCode::StateConflict, error.code);
            let run = original
                .load_setup_run(operation_id)
    ...
    fn offline_store_reset_rejects_a_running_store_owner() {
        ...
        assert_eq!(crate::core::ErrorCode::StoreInUse, error.code);
        assert!(
            recording.exists(),
...
pub struct HostService {
    ...
    turn_execution_timeout: crate::core::session::TimeoutPolicy,
    mode: HostMode,
...
fn configured_turn_execution_timeout(config: &HostConfig) -> crate::core::session::TimeoutPolicy {
    let seconds = config
        .timeouts
        .as_ref()
        .and_then(|timeouts| timeouts.turn_execution.as_ref())
        .map_or(
            (crate::core::DEFAULT_TURN_EXECUTION_TIMEOUT_MS / 1_000) as u32,
            crate::core::TurnExecutionDuration::seconds,
        );
...
fn read_production_snapshot(
    ...
    snapshot.read().map_err(|_| {
        crate::host::runtime::integrity_error(
            "the production capability snapshot lock was poisoned",
        )
    })
}
...
fn provider_validation_outcome_for_error(
    error: &SatelleError,
) -> Option<crate::core::ProviderAuthValidationOutcome> {
    match error.code {
        crate::core::ErrorCode::ProviderSecretResolutionFailed => {
            Some(crate::core::ProviderAuthValidationOutcome::UnresolvedHostSecret)
        }
        crate::core::ErrorCode::ProviderSmokeTestTimeout
        | crate::core::ErrorCode::ExperimentalProviderNotValidated => {
            Some(crate::core::ProviderAuthValidationOutcome::ProviderComputerUseSmokeTestFailed)
        }
        _ if error
            .details
...
struct ProviderSecretPostT0Guard<'a> {
    ...
    operation_id: String,
    paths: crate::core::OwnerOnlySecretFilePaths,
...
fn provider_secret_comparison(
    ...
    let digest = secret
        .expose_to_provider(|value| {
            crate::core::keyed_secret_comparison_digest(key.as_bytes(), value.as_bytes())
        })
        .map_err(|_| {
...
fn provider_secret_file_error() -> SatelleError {
    SatelleError {
        code: crate::core::ErrorCode::ProviderSecretProvisioningRequired,
...
fn provider_secret_source_error() -> SatelleError {
    SatelleError {
        code: crate::core::ErrorCode::ProviderSecretSourceRequired,
...
fn provider_secret_overwrite_error() -> SatelleError {
    SatelleError {
        code: crate::core::ErrorCode::ProviderSecretOverwriteRequired,
        message:
...
pub fn validate_provider_binding_authorization(
    ...
    crate::core::session::EffectiveModelRef::new(authorization.requested_model_alias())
        .map_err(|_| SatelleError::config_error("the model alias is invalid", None))?;
    crate::core::session::ProviderBindingRef::new(authorization.requested_provider_alias())
    ...
    if let Some(source) = authorization.auth_source() {
        ...
        .map_err(|error| match error {
            provider_auth::ProviderAuthResolutionError::InvalidHelperArgv => SatelleError {
                code: crate::core::ErrorCode::CredentialHelperArgvInvalid,
                message:
        ...
        && !authorization.experimental_provider_computer_use()
    {
        return Err(SatelleError {
            code: crate::core::ErrorCode::ExperimentalProviderOptInRequired,
...
fn storage_backup_cleanup_failure_reports_already_removed_names() {
    ...
    assert_eq!(crate::core::ErrorCode::SetupPartiallyApplied, error.code);
    assert_eq!(
...
impl HostService {
    ...
    pub fn stage_storage_migration(
        source: &crate::core::daemon_service::DaemonResolvedPathSet,
    ...
    pub fn acquire_host_update_maintenance(
        &self,
        operation_id: &str,
        recovery_identity: &crate::core::host_update::HostUpdateRecoveryIdentity,
    ) -> Result<(), SatelleError> {
        self.acquire_bootstrap_maintenance_plan_with_identity(
            operation_id,
            SetupOperationKind::HostUpdate,
    ...
    fn acquire_bootstrap_maintenance_plan_with_identity(
        ...
        operation_kind: SetupOperationKind,
        plan_kind: BootstrapMaintenancePlanKind,
        recovery_identity: Option<&crate::core::host_update::HostUpdateRecoveryIdentity>,
    ) -> Result<(), SatelleError> {
    ...
    pub fn plan_setup_repair(
        &self,
        desktop_binding: Option<&crate::core::session::DesktopBindingRef>,
        run_id: Option<&str>,
    ...
    pub fn production() -> Self {
        let config = crate::core::SatelleConfig::defaults()
            .hosts
    ...
    pub fn resolved_daemon_paths_for_host(
        ...
        let paths = crate::core::resolve_path_set(
        ...
        let policy = runtime::ProductionAdapterPolicy {
            ...
            desktop_bindings: config
                ...
                .map(|(alias, binding)| {
                    (
                        alias.clone(),
                        crate::core::DesktopSelectionPolicy::from_binding_config(binding),
                    )
                })
                .collect(),
        };
    ...
    fn production_for_offline_storage(state_root: &std::path::Path) -> Self {
        let config = crate::core::SatelleConfig::defaults()
            ...
            .expect("the built-in local Host config exists");
        let daemon_paths =
            crate::core::daemon_service::DaemonResolvedPathSet::for_offline_state_root(state_root);
    ...
    pub fn production_for_service(
        ...
        storage_policy: crate::core::daemon_service::PersistentHostStoragePolicy,
        telemetry: Option<crate::core::telemetry::TelemetryConfig>,
        recording: Option<crate::core::recording::RecordingPolicy>,
        queue: crate::core::queue::QueueConfig,
    ) -> Result<Self, SatelleError> {
        ...
        config.setup_ledger_retention = Some(
            crate::core::ExplicitDuration::parse(&format!(
                "{}ms",
        ...
        config.session_metadata_retention = Some(
            crate::core::RetentionDuration::parse(&format!(
                "{}h",
    ...
    pub fn commit_fresh_ssh_host_identity(
        state_root: &Path,
        record: &crate::core::SshIdentityCommitRecord,
    ) -> Result<crate::core::session::HostIdentityRef, SatelleError> {
    ...
    #[cfg(feature = "test-support")]
    pub fn local_demo_for_tests(config: &crate::core::HostConfig) -> Result<Self, SatelleError> {
        let runtime = RuntimeHandle::new_with_readiness_probe_driver(
            crate::core::state_dir(),
            FakeComputerUseAdapter,
            FakeComputerUseAdapter,
        );
    ...
    pub fn pending_local_demo_for_tests(
        ...
        let runtime = RuntimeHandle::new(crate::core::state_dir(), PendingComputerUseAdapter);
        runtime.configure_host_policy_for_tests(config)?;
        Ok(Self {
            runtime,
            operation_capacity: Arc::new(OperationCapacity::default()),
    ...
    pub fn readiness_failing_local_demo_for_tests(
        ...
        let runtime =
            RuntimeHandle::new(crate::core::state_dir(), ReadinessFailingComputerUseAdapter);
        runtime.configure_host_policy_for_tests(config)?;
        Ok(Self {
            runtime,
            operation_capacity: Arc::new(OperationCapacity::default()),
    ...
    pub fn resolved_secret_canary_local_demo_for_tests(
        ...
        let runtime = RuntimeHandle::new(crate::core::state_dir(), ResolvedSecretCanaryAdapter);
        runtime.configure_host_policy_for_tests(config)?;
        Ok(Self {
            runtime,
            operation_capacity: Arc::new(OperationCapacity::default()),
    ...
    pub fn failing_local_demo_for_tests(
        ...
        let runtime = RuntimeHandle::new(crate::core::state_dir(), FailingComputerUseAdapter);
        runtime.configure_host_policy_for_tests(config)?;
        Ok(Self {
            runtime,
            operation_capacity: Arc::new(OperationCapacity::default()),
        ...
        if options.refresh() && (includes_native_scope || should_resolve_provider) {
            ...
            let provider_resolution_allows_native = provider_auth_evidence.is_none_or(|outcome| {
                !matches!(
                    outcome.0,
                    crate::core::ProviderAuthValidationOutcome::MissingDescriptor
                        | crate::core::ProviderAuthValidationOutcome::UnsupportedDescriptorKind
                )
            });
                    ...
                    if let Some(native_evidence) = native_evidence {
                        ...
                        let observed = match &provider_refresh {
                            ...
                            Err(error) => provider_validation_outcome_for_error(error)
                                .map(|outcome| {
                                    (outcome, crate::core::ProviderAuthObservationSource::Live)
                                })
    ...
    pub fn authorize_provider_binding(
        ...
        let missing_file_destination = matches!(
            binding.auth_source(),
            Some(crate::core::ProviderSecretSource::File { path })
                if matches!(
                    crate::core::owner_only_secret_destination_exists(path),
                    Ok(false)
                )
        );
    ...
    fn provision_provider_secret(
        ...
        let destination = match binding.auth_source() {
            Some(crate::core::ProviderSecretSource::File { path }) => path.clone(),
        ...
        let workflow =
            (|| -> Result<ProviderSecretProvisioningResult, ProviderSecretPostT0Failure> {
                ...
                let destination_existed =
                    crate::core::owner_only_secret_destination_exists(&destination)
                        .map_err(|_| provider_secret_file_error())?;
                ...
                let prior_comparison = if destination_existed {
                    let prior = crate::core::read_owner_only_secret_file(&destination)
                ...
                candidate_secret
                    .expose_to_provider(|value| {
                        crate::core::stage_owner_only_secret_file(
                            &lifecycle.paths,
                            value,
                ...
                let overwritten = match crate::core::publish_owner_only_secret_file(
                    &lifecycle.paths,
                    destination_existed,
                    ...
                    Err(crate::core::SecureFileError::OverwriteRequired) => {
                ...
                // reusable hash.
                let published_digest = crate::core::keyed_owner_only_secret_file_comparison_digest(
                    &destination,
                    lifecycle.candidate.key.as_bytes(),
                )
                .map_err(|_| provider_secret_file_error())?;
                ...
                if overwritten {
                    let backup = crate::core::read_owner_only_secret_file(lifecycle.paths.backup())
                        .map(provider_auth::ResolvedProviderSecret::from_provisioning)
                        .map_err(|_| provider_secret_file_error())?;
    ...
    fn provider_candidate_intent(
        ...
        Ok(ProviderComputerUseIntent::new(
            Some(
                crate::core::session::EffectiveModelRef::new(binding.requested_model_alias())
                    .map_err(|_| SatelleError::config_error("the model alias is invalid", None))?,
            ),
            Some(
                crate::core::session::ProviderBindingRef::new(binding.requested_provider_alias())
                    .map_err(|_| {
    ...
    pub fn delete_provider_binding(
        ...
        crate::core::session::EffectiveModelRef::new(model_alias)
            .map_err(|_| SatelleError::config_error("the model alias is invalid", None))?;
        crate::core::session::ProviderBindingRef::new(provider_alias)
            .map_err(|_| SatelleError::config_error("the provider alias is invalid", None))?;
        let desktop_binding = crate::core::session::DesktopBindingRef::new(desktop_binding)
            .map_err(|_| SatelleError::desktop_binding_not_found(desktop_binding))?;
        self.runtime
    ...
    pub fn validate_provider_descriptor(
        ...
        let intent =
            if model_alias == DEFAULT_MODEL_BINDING && provider_alias == DEFAULT_PROVIDER_BINDING {
                ...
                ProviderComputerUseIntent::new(
                    Some(
                        crate::core::session::EffectiveModelRef::new(model_alias).map_err(
                ...
                match result {
                    Ok(readiness) => {
                        if readiness.resolved_provider_binding() != Some(&resolved_binding) {
                            return Err(crate::host::runtime::integrity_error(
    ...
    pub fn run(
        ...
        self.runtime
            ...
            .map(crate::host::runtime::RuntimeTurnOutcome::into_command_outcome)
    }
    ...
    pub fn run_detached(
        ...
        self.ensure_image_attachments_supported(intent)?;
        crate::host::runtime::admitted_session(
            self.runtime
    ...
    pub fn steer_detached(
        ...
        self.ensure_image_attachments_supported(intent)?;
        crate::host::runtime::admitted_session(self.runtime.steer(self.steer_command(
    ...
    pub fn raw_protocol_export(
        ...
        principal_ref: &str,
        turn_id: &TurnId,
    ) -> Result<crate::core::sensitive_diagnostics::RawProtocolArtifact, SatelleError> {
    ...
    pub fn acknowledge_raw_protocol_export(
        ...
        principal_ref: &str,
        turn_id: &TurnId,
        outcome: crate::core::sensitive_diagnostics::RawDiagnosticExportOutcome,
    ) -> Result<(), SatelleError> {
        self.runtime
        ...
        match &self.mode {
            ...
            HostMode::TestFake { .. } => {
                let daemon_working_directory =
                    std::env::current_dir().unwrap_or_else(|_| std::path::PathBuf::from("."));
                crate::core::resolve_path_set(&daemon_working_directory)
...
pub trait ControllerTransportProbe: Send + Sync {
    fn execute(
        &self,
        context: &crate::core::doctor::DoctorProbeExecutionContext,
...
impl ControllerTransportProbe for ReadyControllerTransportProbe {
    fn execute(
        &self,
        _context: &crate::core::doctor::DoctorProbeExecutionContext,
    ) -> ControllerTransportProbeOutcome {
...
enum ProductionDoctorTaskEffect {
    ...
    ProviderAuth {
        evidence: Option<(
            crate::core::ProviderAuthValidationOutcome,
            crate::core::ProviderAuthObservationSource,
        )>,
...
impl DoctorTaskRegistry {
    ...
    fn spawn(
        ...
        operation: impl FnOnce(
            crate::core::doctor::DoctorProbeExecutionContext,
                ...
                let mut event = None;
                {
                    ...
                    if let Some(terminal) = task.terminal.take() {
                        ...
                        match task.lifecycle.poll(now, None) {
                            ...
                            Err(
                                crate::core::doctor::DoctorProbeExecutionError::CleanupDeadlineMissed {
                                    ..
                                },
                            ) => {
                            ...
                            Err(
                                crate::core::doctor::DoctorProbeExecutionError::DeadlineOverflow {
                                    ..
                                },
                            ) => unreachable!("deadline overflow is rejected at task start"),
                            Err(
                                crate::core::doctor::DoctorProbeExecutionError::AlreadyTerminal {
                                    ..
                                },
...
fn production_snapshot_after_execution(
    ...
    Err(crate::host::runtime::integrity_error(
...
fn duration_to_time(duration: &crate::core::ExplicitDuration) -> time::Duration {
        ...
        Err(error) => {
            ...
            (
                DoctorFinding {
                    ...
                    } else if error.code == crate::core::ErrorCode::ComputerUseNotReady {
...
fn production_doctor_probes(
    ...
    scopes
        ...
        .map(|scope| {
            ...
            let timeout = probe_timeout.unwrap_or(configured_timeout);
...
-> Result<Vec<crate::core::DesktopSessionRecord>, SatelleError> {
    desktop_sessions::discover()
}

#[doc(hidden)]
#[cfg(feature = "test-support")]
pub fn local_desktop_sessions_for_setup_tests() -> Vec<crate::core::DesktopSessionRecord> {
...
pub struct TurnOutcome {
    ...
    pub recording: Option<crate::core::recording::RecordingManifest>,
}
...
mod packet17_doctor_tests {
    ...
    fn host_default_doctor_graph_uses_dependencies_resources_and_bounded_concurrency() {
        ...
        assert!(first.len() <= crate::core::doctor::DEFAULT_DOCTOR_PROBE_CONCURRENCY);
        ...
        let provider_without_smoke = production_doctor_probes(
            selection.scopes(),
            None,
            false,
            (
    ...
    #[test]
    fn doctor_refresh_probes_keep_their_configured_default_budgets() {
        let selection = DoctorScopeSelection::parse(&[]).expect("default scope is valid");
        let native_timeout = Duration::from_secs(73);
        let provider_timeout = Duration::from_secs(91);
        let probes = production_doctor_probes(
            selection.scopes(),
            None,
            true,
    ...
    fn serial_option_and_zero_timeout_cross_the_typed_scheduler_boundary() {
        ...
        let zero_timeout_probes = production_doctor_probes(
            selection.scopes(),
            Some(Duration::ZERO),
            true,
            readiness_timeouts,
