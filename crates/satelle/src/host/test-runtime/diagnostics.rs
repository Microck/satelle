...
use crate::core::doctor::{DoctorProbeScheduleEvent, DoctorScope, DoctorScopeSelection};
use crate::core::{
...
use crate::host::runtime::ComputerUseAdapter;
...
pub(super) fn doctor(
    ...
    let readiness = adapter.preflight(
        host,
