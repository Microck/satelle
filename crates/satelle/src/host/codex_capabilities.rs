...
impl CodexConfigOriginClass {
    pub(crate) const fn provider_value_origin(self) -> crate::core::ProviderValueOrigin {
        match self {
            Self::Default => crate::core::ProviderValueOrigin::CodexDefault,
            Self::User => crate::core::ProviderValueOrigin::CodexUser,
            Self::Project => crate::core::ProviderValueOrigin::CodexProject,
            Self::Managed => crate::core::ProviderValueOrigin::CodexManaged,
            Self::Session => crate::core::ProviderValueOrigin::CodexSession,
            Self::Other => crate::core::ProviderValueOrigin::CodexOther,
        }
    }
}
...
impl Phase0CapabilityBlocker {
    ...
    pub(crate) fn doctor_readiness_blocker(
        &self,
    ) -> Option<crate::core::doctor::DoctorReadinessBlocker> {
        use crate::core::doctor::DoctorReadinessBlocker;
