use crate::core::DesktopSessionRecord;

pub(super) fn discover() -> Result<Vec<DesktopSessionRecord>, crate::core::SatelleError> {
    platform::observe().map(|observation| observation.and_then(record).into_iter().collect())
}

pub(super) fn current_process_user() -> Result<String, crate::core::SatelleError> {
...
mod platform {
    ...
    pub(super) fn observe() -> Result<Option<DesktopObservation>, crate::core::SatelleError> {
        Ok(None)
    }
