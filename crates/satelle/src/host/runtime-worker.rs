...
use crate::core::session::{ExpectedRevisions, Session, TurnExecutionMode, TurnTransition};
use crate::core::{ResolvedProviderBinding, SatelleError, SatelleEvent, SessionId, TurnId};
...
fn refresh_once(
    storage: &Arc<Mutex<crate::host::storage::Storage>>,
    owner: &LeaseOwner,
...
pub(super) struct TurnWork {
    pub(super) session: crate::core::session::Session,
...
pub(super) struct ExecutionPlan {
    ...
    pub(super) provider_smoke_event: Option<crate::core::SatelleEventBody>,
    pub(super) resolved_provider_binding: Option<ResolvedProviderBinding>,
    pub(super) resolved_provider_secret: Option<crate::host::provider_auth::ResolvedProviderSecret>,
...
impl RuntimeEngine {
    ...
    fn finish_recording(
        &self,
        capture: &crate::host::recording::RecordingCapture,
        events: &[crate::core::SatelleEvent],
    ) -> Result<crate::core::recording::RecordingManifest, SatelleError> {
    ...
    fn execute_once(
        ...
        let publish_live_event = |event: crate::core::SatelleEventBody| {
            let attached = event
                .clone()
                .with_host(&plan.host)
        ...
        let Some(transition) = result.transition() else {
            ...
            if turn.state() != crate::core::session::TurnState::Stopped {
                return runtime_failure_with_events(
    ...
    ) -> Result<(Session, Option<crate::core::SatelleEventBody>), SatelleError> {
...
fn prepend_runtime_events(
    ...
    live_events: Vec<crate::core::SatelleEventBody>,
    events: Vec<SatelleEvent>,
    terminal_event: Option<crate::core::SatelleEventBody>,
...
mod heartbeat_tests {
    use super::*;
    use crate::host::storage::{
        LeaseOwner, SetupActionPlan, SetupOperationKind, SetupRunPlan, Storage,
    };
