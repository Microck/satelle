...
use crate::core::{SatelleEvent, SatelleEventBody, SessionId, TurnId};
...
impl AdmissionCancellation {
    ...
    pub(crate) fn with_commit_gate<T>(
        ...
        session_id: SessionId,
        turn_id: TurnId,
        operation: impl FnOnce() -> Result<T, crate::core::SatelleError>,
    ) -> Result<T, crate::core::SatelleError> {
        let _commit = self
            .inner
            .commit
            .lock()
        ...
        if self.is_requested() {
            ...
            return Err(crate::core::SatelleError::interrupted_attached_command());
        }
...
pub(crate) struct RunCommand<'a> {
    ...
    pub(super) turn_execution_timeout: Option<crate::core::session::TimeoutPolicy>,
    pub(super) attachments: Vec<crate::host::attachment::VerifiedImageAttachment>,
    pub(super) raw_protocol_source_host: Option<String>,
    pub(super) recording: Option<crate::core::recording::RecordingRequest>,
    pub(super) desktop_binding: crate::core::session::DesktopBindingRef,
}
...
impl<'a> RunCommand<'a> {
    ...
    pub(crate) fn attached_with_identity(
        ...
        Self {
            ...
            recording: None,
            desktop_binding: crate::core::session::DesktopBindingRef::new("local-demo-desktop-v1")
    ...
    pub(crate) fn with_turn_execution_timeout(
        mut self,
        timeout: Option<crate::core::session::TimeoutPolicy>,
    ) -> Self {
    ...
    pub(crate) fn with_attachments(
        mut self,
        attachments: Vec<crate::host::attachment::VerifiedImageAttachment>,
    ) -> Self {
    ...
    fn published_live_events_remain_visible_to_both_operation_consumers() {
        ...
        cancellation.live_event_buffer().publish(
            SatelleEventBody::new(
                crate::core::EventType::ActionRequired,
                crate::core::EventSource::CodexAdapter,
    ...
    fn cancellation_before_commit_prevents_the_storage_operation() {
        ...
        assert_eq!(
            result
                ...
                .code,
            crate::core::ErrorCode::Interrupted
        );
