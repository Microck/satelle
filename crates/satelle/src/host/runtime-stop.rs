...
use crate::core::session::TurnState;
use crate::core::{ControlPlaneOperation, SatelleError, SessionId, StopResult};
use crate::host::storage::{BeginStopOutcome, StopCommit, StopCommitOutcome, StorageErrorKind};

#[derive(Clone)]
pub(crate) struct RuntimeStopOutcome {
    pub(crate) result: StopResult,
    pub(crate) session_state_revision: crate::core::session::SessionStateRevision,
    pub(crate) turn_state_revision: crate::core::session::TurnStateRevision,
}
