...
pub(crate) fn prepare_provider_binding(
    mut authorization: crate::core::ProviderBindingAuthorization,
    source: crate::core::ProviderBindingSource,
    host: &str,
) -> Result<crate::core::ResolvedProviderBinding, crate::core::SatelleError> {
    crate::host::validate_provider_binding_authorization(&authorization)?;
    ...
    Ok(crate::core::ResolvedProviderBinding::from_authorization(
        authorization,
        source,
    ))
}
...
pub(crate) fn resolve_provider_secret(
    ...
    helper_request: &crate::host::credential_helper::CredentialHelperRequest<'_>,
    ...
    let value = match source {
        ...
        ProviderSecretSource::ExecutableHelper(helper) => {
            crate::host::credential_helper::resolve(helper, helper_request)?
        }
...
mod tests {
    use super::*;
    use crate::core::ProviderSecretSource;
    #[cfg(unix)]
    use crate::core::persist_new_owner_only_secret_file;
    use std::path::{Path, PathBuf};

    fn helper_request() -> crate::host::credential_helper::CredentialHelperRequest<'static> {
    ...
    fn file_paths_follow_the_target_host_absolute_path_rules() {
        assert_eq!(
            ...
            .unwrap_err()
            .code,
            crate::core::ErrorCode::SecretFilePathNotAbsolute
        );
        assert_eq!(
            Ok(()),
    ...
    fn secret_file_home_resolution_reads_only_the_daemon_accounts_private_file() {
        ...
        crate::core::persist_new_owner_only_secret_file(&path, "home-provider-token")
        ...
        let binding = prepare_provider_binding(
            crate::core::ProviderBindingAuthorization::new("model", "provider", "model", "openai")
