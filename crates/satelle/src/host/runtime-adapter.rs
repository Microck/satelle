...
use crate::host::storage::RecoverySubject;
...
pub struct ProviderComputerUseIntent {
    model: Option<crate::core::session::EffectiveModelRef>,
    provider: Option<crate::core::session::ProviderBindingRef>,
...
impl ProviderComputerUseIntent {
    ...
    pub fn model(&self) -> Option<&crate::core::session::EffectiveModelRef> {
        self.model.as_ref()
    }

    pub fn provider(&self) -> Option<&crate::core::session::ProviderBindingRef> {
    ...
    pub(crate) fn resolved_provider_binding(
        &self,
    ) -> Option<&crate::core::ResolvedProviderBinding> {
...
pub(crate) struct PreparedProviderSecret {
    secret: std::sync::Arc<
        std::sync::Mutex<Option<crate::host::provider_auth::ResolvedProviderSecret>>,
    >,
}

impl PreparedProviderSecret {
    pub(crate) fn new(secret: Option<crate::host::provider_auth::ResolvedProviderSecret>) -> Self {
        Self {
            secret: std::sync::Arc::new(std::sync::Mutex::new(secret)),
        }
    }

    pub(crate) fn take(&self) -> Option<crate::host::provider_auth::ResolvedProviderSecret> {
        self.secret
            .lock()
...
impl AdapterReadiness {
    ...
    pub(crate) fn with_resolved_provider_secret(
        mut self,
        secret: Option<crate::host::provider_auth::ResolvedProviderSecret>,
    ) -> Self {
    ...
    pub(crate) fn take_resolved_provider_secret(
        &self,
    ) -> Option<crate::host::provider_auth::ResolvedProviderSecret> {
...
impl<'a> AdapterSubject<'a> {
    ...
    pub(crate) fn turn_state(self) -> crate::core::session::TurnState {
    ...
    pub(crate) fn upstream_thread_ref(self) -> Option<&'a str> {
        self.subject
            .upstream_thread_ref()
            .map(crate::host::storage::PrivateUpstreamRef::as_str)
    }
...
pub struct ExecuteRequest<'a> {
    ...
    resolved_provider_binding: Option<&'a crate::core::ResolvedProviderBinding>,
    ...
    attachments: &'a [crate::host::attachment::StagedImage],
    raw_protocol_capture: Option<crate::host::raw_diagnostics::RawProtocolCapture>,
    recording_capture: Option<crate::host::recording::RecordingCapture>,
}

pub(super) struct ExecuteHooks<'a> {
    persist_upstream_ref: &'a dyn Fn(UpstreamReference) -> Result<(), SatelleError>,
    publish_live_event: &'a dyn Fn(crate::core::SatelleEventBody),
...
impl<'a> ExecuteRequest<'a> {
    ...
    pub(super) const fn with_resolved_provider_binding(
        mut self,
        binding: Option<&'a crate::core::ResolvedProviderBinding>,
    ) -> Self {
    ...
    pub(crate) const fn attachments(&self) -> &'a [crate::host::attachment::StagedImage] {
        self.attachments
    }

    pub(super) fn with_raw_protocol_capture(
        mut self,
        capture: Option<crate::host::raw_diagnostics::RawProtocolCapture>,
    ) -> Self {
        self.raw_protocol_capture = capture;
        self
    }

    pub(crate) fn raw_protocol_capture(
        &self,
    ) -> Option<&crate::host::raw_diagnostics::RawProtocolCapture> {
        self.raw_protocol_capture.as_ref()
    }

    pub(super) fn with_recording_capture(
        mut self,
        capture: Option<crate::host::recording::RecordingCapture>,
    ) -> Self {
        self.recording_capture = capture;
        self
    }

    pub(crate) fn recording_capture(&self) -> Option<&crate::host::recording::RecordingCapture> {
        self.recording_capture.as_ref()
    }

    pub const fn execution_mode(&self) -> crate::core::session::TurnExecutionMode {
        self.execution_mode
    }
    ...
    pub const fn resolved_provider_binding(
        &self,
    ) -> Option<&'a crate::core::ResolvedProviderBinding> {
    ...
    pub fn publish_live_event(&self, event: crate::core::SatelleEventBody) {
...
pub trait ComputerUseAdapter: Send + Sync + 'static {
    ...
    fn resolve_provider_binding(
        ...
        Err(SatelleError {
            code: crate::core::ErrorCode::ModelProviderBindingMissing,
