...
fn reject_provider_binding_errors(path: &Path, value: &toml::Value) -> Result<(), SatelleError> {
    ...
    for (host_alias, host_value) in hosts {
        ...
        for (desktop_alias, desktop_value) in desktop_bindings {
            crate::core::session::DesktopBindingRef::new(desktop_alias.clone()).map_err(|_| {
                SatelleError::config_error(
                    format!(
            ...
            for (provider_alias, model_bindings) in provider_bindings {
                ...
                crate::core::session::ProviderBindingRef::new(provider_alias.clone()).map_err(|_| {
                SatelleError::config_error(
                    format!(
                ...
                for (model_alias, binding) in model_bindings {
                    ...
                    crate::core::session::EffectiveModelRef::new(model_alias.clone()).map_err(|_| {
                        SatelleError::config_error(
                            format!(
...
impl SatelleError {
    ...
    pub fn host_update_postcheck_failed(
        report: &crate::core::host_update::HostUpdateReport,
        source: impl Into<String>,
    ) -> Self {
    ...
    pub fn setup_partially_applied(
        report: &crate::core::host_update::RepairUpgradeReport,
        failed_action: &str,
        source: impl Into<String>,
    ) -> Self {
        let recovery_command = report.recovery_command.clone().or_else(|| {
...
mod error_contract_tests {
    ...
    fn host_update_recovery_commands_quote_host_aliases() {
        ...
        let mut report = crate::core::host_update::HostUpdateReport::new(
            host,
            vec![crate::core::host_update::HostUpdateComponent::Host],
            Vec::new(),
        );
        report.changed = true;
        let partial =
        ...
        let repair = crate::core::host_update::RepairUpgradeReport::new(host, Vec::new())
            .partial_failure(
    ...
    fn setup_failures_distinguish_pre_mutation_and_partial_results() {
        ...
        let report = RepairUpgradeReport::new(
            ...
            vec![RepairUpgradeAction {
                ...
                target: crate::core::host_update::HostUpdateTarget::HostDaemon,
                current_version: Some("1.0.0".to_string()),
                target_version: "1.1.0".to_string(),
                compatibility_reason: Some(RepairCompatibilityReason::BelowMinimumVersion),
                version_source:
                    crate::core::host_update::HostUpdateVersionSource::HostCompatibilityRequirement,
