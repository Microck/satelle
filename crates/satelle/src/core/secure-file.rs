...
use crate::core::sensitive_diagnostics::MAX_RAW_PROTOCOL_BYTES;
...
pub struct SshIdentityCommitRecord {
    operation_id: String,
    candidate_host_identity: crate::core::session::HostIdentityRef,
    target_id: String,
...
impl SshIdentityCommitRecord {
    ...
    pub fn parse(encoded: &str) -> Result<Self, SecureFileError> {
        ...
        let candidate_host_identity = crate::core::session::HostIdentityRef::new(field(
            lines.next(),
            "candidate_host_identity=",
        )?)
    ...
    pub fn candidate_host_identity(&self) -> &crate::core::session::HostIdentityRef {
...
pub fn persist_new_owner_only_desktop_snapshot(
    ...
    persist_new_owner_only_staged_file(
        ...
        staging_path,
        contents,
        crate::core::sensitive_diagnostics::MAX_DESKTOP_SNAPSHOT_BYTES,
    )
}
...
mod tests {
    ...
    fn ssh_identity_record(
        ...
        SshIdentityCommitRecord::new(
            ...
            crate::core::session::HostIdentityRef::new(
