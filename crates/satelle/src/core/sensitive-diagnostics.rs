...
impl RawDiagnosticFailure {
    pub const fn code(self) -> crate::core::ErrorCode {
        match self {
            Self::RedactionFailed => crate::core::ErrorCode::RawDiagnosticsRedactionFailed,
            Self::StagingFailed => crate::core::ErrorCode::RawDiagnosticsStagingFailed,
            Self::ExportFailed => crate::core::ErrorCode::RawDiagnosticsExportFailed,
        }
    }
}
