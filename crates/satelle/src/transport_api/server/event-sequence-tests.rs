...
use crate::core::{SatelleEvent, SessionId, TurnId};
use crate::host::{ApiBearerToken, ApiScopes, HostService, test_support::TestStateDir};
use crate::transport::{
    DaemonClient, DaemonEventClient, DaemonServer, DaemonServerConfig, TurnRequest,
};
...
async fn read_target_turn_events(
    stream: &mut crate::transport::DaemonEventStream,
