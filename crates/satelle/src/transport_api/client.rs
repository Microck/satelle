use crate::core::session::{EffectiveModelRef, ProviderBindingRef};
use crate::core::{DirectHostBinding, QueueRequestId, SessionId, TurnId};
use crate::host::{ApiBearerToken, LogPageMode, LogPageQuery};
...
use crate::transport::transport_tls::{
...
impl DaemonClient {
    ...
    pub fn host_telemetry_status(
        &self,
    ) -> Result<crate::transport::HostTelemetryStatusResponse, DaemonClientError> {
    ...
    pub fn setup_history(
        &self,
    ) -> Result<crate::transport::SetupHistoryResponse, DaemonClientError> {
        let (request, request_id) =
    ...
    pub fn local_setup_operation(
        ...
        daemon_path_overrides: crate::core::DaemonPathOverrides,
        idempotency_key: &str,
    ) -> Result<Result<crate::core::SetupReport, crate::core::SatelleError>, DaemonClientError>
    {
    ...
    pub fn local_doctor_operation(
        &self,
        host: &str,
        scope_selection: &crate::core::doctor::DoctorScopeSelection,
        options: crate::core::DoctorOptions,
        provider_intent: &crate::host::ProviderComputerUseIntent,
        idempotency_key: &str,
    ) -> Result<crate::host::DoctorExecutionResult, DaemonClientError> {
        let request =
    ...
    pub fn prepare_provider_secret_provisioning(
        ...
        let recipient_public_key =
            crate::transport::provider_secret_crypto::decode_canonical_base64(
                preview.recipient_public_key(),
            )
        ...
        let aad =
            provider_secret_upload_aad(preview, metadata, self.token.token_id(), idempotency_key)
                .map_err(|_| DaemonClientError::ResponseContractViolation)?;
        let sealed = crate::transport::provider_secret_crypto::encrypt_provider_secret(
        ...
        let envelope = ProviderSecretUploadEnvelope::new(
            preview,
            metadata.clone(),
            crate::transport::provider_secret_crypto::encode_canonical_base64(
                &sealed.encapsulated_key,
            ),
            crate::transport::provider_secret_crypto::encode_canonical_base64(&sealed.ciphertext),
        );
    ...
    pub fn begin_storage_migration(
        ...
        self.send_authenticated(
            request.json(&crate::transport::StorageMigrationPathsRequest::new(
                expected_paths,
            )),
            request_id,
            StatusCode::OK,
    ...
    pub fn preview_storage_migration_source(
        &self,
        operation_id: &str,
    ) -> Result<crate::transport::StorageMigrationCleanupResponse, DaemonClientError> {
    ...
    pub fn begin_host_update_maintenance(
        ...
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(
            request.json(&crate::transport::HostUpdateMaintenanceRequest::new(
    ...
    pub fn begin_repair_maintenance(
        ...
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(
            request.json(&crate::transport::RepairMaintenanceRequest::new(
                recovery_identity.clone(),
            )),
            request_id,
            StatusCode::OK,
    ...
    pub fn start_maintenance_action(
        ...
        let path = format!("/v1/maintenance/bootstrap/{operation_id}/action/{action_id}/start");
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(request, request_id, StatusCode::OK)
    }

    pub fn complete_maintenance_action(
        &self,
        operation_id: &str,
        action_id: &str,
    ) -> Result<BootstrapMaintenanceResponse, DaemonClientError> {
        let path = format!("/v1/maintenance/bootstrap/{operation_id}/action/{action_id}/complete");
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(request, request_id, StatusCode::OK)
    }

    pub fn skip_maintenance_action(
        &self,
        operation_id: &str,
        action_id: &str,
    ) -> Result<BootstrapMaintenanceResponse, DaemonClientError> {
        let path = format!("/v1/maintenance/bootstrap/{operation_id}/action/{action_id}/skip");
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(request, request_id, StatusCode::OK)
    }

    pub fn fail_maintenance_action(
        &self,
        operation_id: &str,
        action_id: &str,
        failure_kind: &str,
    ...
    pub fn finish_maintenance_plan(
        &self,
        operation_id: &str,
    ) -> Result<BootstrapMaintenanceResponse, DaemonClientError> {
        let path = format!("/v1/maintenance/bootstrap/{operation_id}/finish");
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(request, request_id, StatusCode::OK)
    }
    ...
    pub fn run_maintenance_postcheck(
        ...
        let path = format!("/v1/maintenance/bootstrap/{operation_id}/action/{action_id}/postcheck");
        let (request, request_id) = self.mutation_request(&path, operation_id)?;
        self.send_authenticated(request, request_id, StatusCode::OK)
    }
    ...
    pub fn stop_session_for_turn(
        &self,
        session_id: &SessionId,
        expected_turn_id: &crate::core::TurnId,
        idempotency_key: &str,
    ) -> Result<StopResponse, DaemonClientError> {
    ...
    fn stop_session_inner(
        &self,
        session_id: &SessionId,
        expected_turn_id: Option<&crate::core::TurnId>,
        idempotency_key: &str,
    ) -> Result<StopResponse, DaemonClientError> {
...
mod tests {
    ...
    fn logs_response_rejects_entries_outside_requested_filters() {
        ...
        let query = LogPageQuery::tail(50)
            .expect("construct tail Log query")
            .with_session(requested_session)
            .with_sources([crate::host::LogSource::CodexAdapter])
            .with_minimum_severity(crate::host::LogSeverity::Warning)
    ...
    fn provider_binding_authorization_uses_the_admission_deadline() {
        ...
        let public_binding = crate::core::PublicResolvedProviderBinding::from(
        ...
        let response = client
            .authorize_provider_binding(
                "openai",
                "review",
                &ProviderBindingAuthorizationRequest::new("local-demo-desktop-v1", authorization),
