...
use crate::core::{ApiRateLimits, DesktopSessionRecord};
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            platform: Platform {
                ...
                target: crate::core::host_update::current_host_artifact_platform(),
            },
            operations: vec![
                Operation::Live,
...
impl MaintenanceUpdateEvidenceResponse {
    ...
    pub const fn codex_update_evidence(&self) -> &crate::core::host_update::CodexUpdateEvidence {
...
pub struct HostTelemetryStatusResponse {
    ...
    request_id: RequestId,
    host_identity: String,
    status: crate::core::telemetry::TelemetryStatus,
}
...
impl HostTelemetryStatusResponse {
    ...
    pub fn into_status(self) -> crate::core::telemetry::TelemetryStatus {
        self.status
    }
}
...
pub struct SetupHistoryResponse {
    ...
    request_id: RequestId,
    host_identity: String,
    history: crate::host::SetupHistory,
}
...
impl SetupHistoryResponse {
    ...
    pub fn into_history(self) -> crate::host::SetupHistory {
        self.history
    }
}
    ...
    fn host_paths_exposes_only_daemon_authoritative_paths() {
        ...
        let paths = DaemonResolvedPathSet {
            ...
            sources: crate::core::SatellePathSources {
                config_file: crate::core::PathSource::ServiceConfig,
                cache_root: crate::core::PathSource::ServiceConfig,
                state_root: crate::core::PathSource::ServiceConfig,
                sqlite_store: crate::core::PathSource::ServiceConfig,
                operator_log_root: crate::core::PathSource::ServiceConfig,
                recording_root: crate::core::PathSource::ServiceConfig,
                project_config_file: crate::core::PathSource::ProjectDiscovery,
                install_receipt: crate::core::PathSource::ServiceConfig,
            },
