...
use crate::core::queue::{QueueCancelResult, QueueStatus};
...
use crate::core::{SessionId, StopResult, StopResultOutcome, TurnId};
...
pub(crate) struct TurnRequestParts {
    ...
    pub(crate) recording: Option<crate::core::recording::RecordingRequest>,
...
impl RecordingPreflightRequest {
    ...
    pub const fn mode(&self) -> crate::core::recording::RecordingMode {
        self.mode
    }
...
pub struct RecordingPreflightResponse {
    ...
    preflight: crate::core::recording::RecordingPreflight,
}
...
impl RecordingPreflightResponse {
    ...
    pub fn into_preflight(self) -> crate::core::recording::RecordingPreflight {
        self.preflight
    }
}
...
pub struct RecordingManifestResponse {
    ...
    request_id: RequestId,
    host_identity: String,
    manifest: crate::core::recording::RecordingManifest,
}
...
impl RecordingManifestResponse {
    ...
    pub fn into_manifest(self) -> crate::core::recording::RecordingManifest {
        self.manifest
    }
}
...
impl TurnRequest {
    ...
    pub fn with_recording(mut self, recording: crate::core::recording::RecordingRequest) -> Self {
    ...
    pub const fn recording(&self) -> Option<&crate::core::recording::RecordingRequest> {
...
pub struct QueueStatusResponse {
    schema_version: QueueStatusResponseSchema,
    request_id: RequestId,
    host_identity: String,
    status: QueueStatus,
}
...
impl QueueStatusResponse {
    pub(crate) fn new(request_id: RequestId, host_identity: String, status: QueueStatus) -> Self {
        Self {
            schema_version: QueueStatusResponseSchema,
            request_id,
            host_identity,
    ...
    pub fn into_status(self) -> QueueStatus {
        self.status
    }
}

impl AuthenticatedResponseContract for QueueStatusResponse {
    fn request_id(&self) -> &RequestId {
        &self.request_id
    }
...
pub struct QueueCancelResponse {
    schema_version: QueueCancelResponseSchema,
    request_id: RequestId,
    host_identity: String,
...
impl QueueCancelResponse {
    ...
    pub fn into_result(self) -> QueueCancelResult {
        self.result
    }
}

impl AuthenticatedResponseContract for QueueCancelResponse {
    fn request_id(&self) -> &RequestId {
        &self.request_id
    }
...
mod provider_binding_boundary_tests {
    ...
    fn turn_request_v12_carries_independent_project_provenance_and_opt_ins() {
        let request = TurnRequest::new("inspect the repository")
            ...
            .with_recording(crate::core::recording::RecordingRequest::new(
