...
impl StorageMigrationPathsRequest {
    pub fn new(expected_paths: crate::core::daemon_service::DaemonResolvedPathSet) -> Self {
        Self {
            schema_version: StorageMigrationPathsSchema,
            expected_paths,
        }
    ...
    pub fn expected_paths(&self) -> &crate::core::daemon_service::DaemonResolvedPathSet {
        &self.expected_paths
    }
}
...
pub struct StorageMigrationCleanupResponse {
    ...
    cleanup: crate::host::StorageMigrationCleanup,
}
...
impl StorageMigrationCleanupResponse {
    ...
    pub fn into_cleanup(self) -> crate::host::StorageMigrationCleanup {
        self.cleanup
    }
}
...
pub(crate) fn provider_secret_upload_aad(
    ...
    for field in [
        ...
        crate::core::LOCAL_DEMO_HOST.as_bytes(),
