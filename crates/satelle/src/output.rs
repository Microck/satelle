...
use satelle::core::session::{PublicSession, PublicTurn, TurnState};
...
impl OutputArgs {
    ...
    pub(crate) fn resolve_with_default(
        self,
        events: EventOutput,
        default: Option<satelle::core::PresentationOutputFormat>,
        ...
        Ok(if self.json {
            ...
            self.format.unwrap_or(match default {
                Some(satelle::core::PresentationOutputFormat::Json) => OutputFormat::Json,
                Some(satelle::core::PresentationOutputFormat::Human) | None => OutputFormat::Human,
            })
        })
    }
