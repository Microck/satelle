use satelle::command_group::AsyncCommandGroup as _;
use satelle::core::doctor::{
...
use satelle::host::{ControllerTransportProbe, ControllerTransportProbeOutcome};
...
) -> Result<Option<PreparedTransportOnlyDoctor>, satelle::core::SatelleError> {
...
) -> Result<DoctorReport, satelle::core::SatelleError> {
...
async fn drain_after_group_kill(
    child: &mut satelle::command_group::AsyncGroupChild,
...
mod tests {
    use super::*;
    use satelle::core::{AdapterKind, ApiTokenSource};
    ...
    fn transport_only_doctor_report(
        ...
        probe: &TailscaleDoctorProbe,
        options: DoctorOptions,
    ) -> Result<Option<DoctorReport>, satelle::core::SatelleError> {
