use super::*;
use reqwest::Method;
use satelle::transport::{StopRequest, TurnRequest};
...
async fn capabilities_handshake_rejects_old_and_missing_clients() {
    ...
    assert_protocol_error(&running, old, "unsupported", Some("10")).await;
    ...
    assert_eq!(current.headers()["satelle-protocol-version"], "22");
}
