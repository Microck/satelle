...
description: Binary-derived command help and public schema versions for Satelle 0.1.5.
---

This page describes **Satelle 0.1.5**. The documentation contract regenerates
...
Commands:
  bundle  Unavailable in this release: support bundle export is not implemented
  help    Print this message or the help of the given subcommand(s)
...
```text
Unavailable in this release: support bundle export is not implemented
