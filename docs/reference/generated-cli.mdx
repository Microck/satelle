...
| --- | --- | --- |
| `BATCH_REQUEST_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.batch.request.v1` |
| `BATCH_RESULT_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.batch.result.v1` |
| `BATCH_SUMMARY_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.batch.summary.v1` |
| `CONFIG_REPAIR_SCHEMA_VERSION` | `crates/satelle-cli/src/output.rs` | `satelle.config.repair.v1` |
...
| `HOST_UPDATE_PLAIN_SCHEMA_VERSION` | `crates/satelle-cli/src/output.rs` | `satelle.host.update.plain.v1` |
| `LogEntrySchema` | `crates/satelle-host/src/log-page.rs` | `satelle.logs.entry.v2` |
| `NOTIFY_WEBHOOK_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.notify.webhook.v1` |
| `REPL_TRANSCRIPT_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.repl.transcript.v1` |
...
| `SUPPORT_BUNDLE_SCHEMA_VERSION` | `crates/satelle-cli/src/support.rs` | `satelle.support.bundle.v1` |
| `TELEMETRY_STATUS_SCHEMA_VERSION` | `crates/satelle-core/src/telemetry.rs` | `satelle.telemetry.status.v1` |
| `WATCH_CHANGE_SCHEMA_VERSION` | `crates/satelle-cli/src/automation.rs` | `satelle.watch.change.v1` |
